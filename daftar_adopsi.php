            ...
            <tr>
              ...
              <td><?php 
                        if($kucing['is_adopted'] == '0'){
                          echo "<span class='badge badge-secondary'>Menunggu konfirmasi pemilik</span>";
                        }else{
                          if($kucing['is_adoption'] == '1'){
                            echo "<span class='badge badge-secondary'>Terpilih menjadi pengadopsi</span>";
                          }else{
                            echo "<span class='badge badge-secondary'>Adopsi diserahkan kepada orang lain</span>";
                          }
                        }
                      ?></td>
              <td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" autocomplete="off" placeholder="Masukkan judul iklan"
              name="judul_iklan" required="">
          </div>

          <div class="mb-3">
            <label class="form-label">Nama Kucing</label>
            <input type="text" class="form-control" autocomplete="off" placeholder="Masukkan nama kucing"
              name="nama_kucing" required="">
          </div>

          <div class="mb-3">
            <label class="form-label">Jenis Kucing</label>
            <input type="text" class="form-control" autocomplete="off" placeholder="Ex : Persia, Anggota, dll."
              name="jenis" required="">
          </div>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" required="" name="deskripsi"
              placeholder="Ketikkan deskripsi kucing yang akan diadopsi"></textarea>
          </div>
