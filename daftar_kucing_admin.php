            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-primary" href="daftar_kucing_detail_admin.php?id=<?= $kucing['id'] ?>">Lihat Detail</a>

                  <?php if($_SESSION['login_data']['akses'] == 'user' && $kucing['is_adopted'] == '0'){ ?>
                  <a href="daftar_kucing_ubah.php?id=<?= $kucing['id'] ?>" class="btn btn-warning">Ubah</a>
                  <a href="proses/kucing_hapus.php?id=<?= $kucing['id'] ?>" onclick="return confirm('Hapus data ?')"
